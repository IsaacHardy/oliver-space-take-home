  ...
  return (
    <div className="Home">
      ...
      <p>
        ...
        finish, but don't go over time. The expectation is not that you will get
        through all of the requirements, so please add notes on anything else
        you would have done with more time. Feel free to use any third-party
        libraries that you find helpful.
      </p>
      ...
      <h4>
        ...
        <a href="mailto:frontend-eng@oliver.space">frontend-eng@oliver.space</a>
